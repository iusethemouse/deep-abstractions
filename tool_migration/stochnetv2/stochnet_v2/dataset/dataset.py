...
class DataTransformer:
    ...
    def drop_timestamps(self):
        ...
        if self.with_timestamps is True:
            ...
            if self.with_labels is True:
                ...
                self.labels = bidict(
                    zip([k - 1 for k in self.labels.keys()], self.labels.values())
                )
    ...
    def rescale(self, data):
        ...
        if isinstance(self.scaler, StandardScaler):
            try:
                ...
                data = (
                    data - self.scaler.mean_[: -self.nb_randomized_params]
            ...
            try:
                ...
                data = (
                    data * self.scaler.scale_[: -self.nb_randomized_params]
    ...
    def scale_back(self, data):
        ...
        if isinstance(self.scaler, StandardScaler):
            ...
            try:
                ...
                data = (
                    data - self.scaler.min_[: -self.nb_randomized_params]
                ) / self.scaler.scale_[: -self.nb_randomized_params]
        return data
    ...
    def _train_test_generators(
        ...
        n_train_trajectories = int((1.0 - test_fraction) * self.nb_trajectories)
    ...
    def save_data_for_ml_hdf5(
        ...
        with h5py.File(train_fp, "a", libver="latest") as df:
            ...
            LOGGER.info(
                f"Train data saved to {train_fp}, \n"
...
class HDF5Dataset(BaseDataset):
    ...
    def __iter__(self):
        ...
        with h5py.File(self._data_file_path, "r", libver="latest") as df:
            ...
            batch_idxs = np.arange(0, n_batches) if n_batches > 0 else np.asarray([0])
